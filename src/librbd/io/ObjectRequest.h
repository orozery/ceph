...
public:
  ...
  ~ObjectReadRequest() {
    if (this->rados_completion) {
      this->rados_completion->release();
    }
  }
...
protected:
  uint64_t m_object_off, m_object_len;
